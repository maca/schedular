...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "Rakefile",
     "VERSION",
     "app/views/events/events/edit.html.erb",
     "app/views/events/events/index.html.erb",
     "app/views/events/events/new.html.erb",
     "app/views/events/events/show.html.erb",
     "config/routes.rb",
     "lib/events.rb",
     "lib/events/event.rb",
     "lib/events/events_controller.rb",
     "lib/events/time.rb",
     "rails/init.rb",
     "test/controllers/events_controller_test.rb",
     "test/helper.rb",
     "test/models/event_test.rb",
     "test/models/time_test.rb",
  ...
  s.homepage = %q{http://github.com/maca/events}
